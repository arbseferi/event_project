...
<v-app id="app">
    <v-row class="fill-height d-flex align-center justify-center">
        <v-col class="d-flex align-center justify-center">
            <v-img class="ml-16" style="border-radius: 12px;" height="100%" width="80%" :src="eventImg">
            </v-img>
        </v-col>
        <v-col class="d-flex align-center justify-center">
        <v-card v-if="mode" color="transparent" flat elevation="8" class="py-8 px-16 mr-16">
            ...
            <v-text-field v-model="username" label="Username or Email" dense outlined></v-text-field>
            <v-text-field v-model="password" type="password" label="Password" dense outlined></v-text-field>
            <v-card-actions>
                <v-spacer />
        ...
        <v-card v-if="!mode" color="transparent" flat elevation="8" class="py-8 px-16 mr-16">
            ...
            <v-text-field v-model="registerName" label="Name" :rules="rules" dense outlined></v-text-field>
            <v-text-field v-model="registerSurname" label="Surname" :rules="rules" dense outlined></v-text-field>
            <v-text-field v-model="registerPhone" label="Phone" type="number" :rules="rules" dense outlined></v-text-field>
            <v-text-field v-model="registerEmail" label="Email" :rules="emailRules" dense outlined></v-text-field>
            <v-text-field v-model="registerUsername" label="Username" :rules="rules" dense outlined></v-text-field>
            <v-text-field v-model="registerPassword" type="password" label="Password" :rules="rules" dense outlined></v-text-field>
            <v-card-actions>
                <v-spacer />
